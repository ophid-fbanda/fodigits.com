...
const products = [
  {
    ...
    story:
      "Deploy with Docker Compose. Data stays on your database volume. Integrates with FoDigits Stock for warehouse counts.",
  },
  {
    slug: "meet",
    tone: "#22c55e",
    ...
    story:
      "The Compose stack includes the app, media server, and TURN. Pair with FoDigits Clinic for scheduled teleconsults.",
  },
  {
    slug: "clinic",
    tone: "#06b6d4",
  ...
  },
  {
    ...
    story:
      "Tablet-ready receiving screen. Works alongside FoDigits Assets.",
  },
  {
    slug: "people",
    tone: "#fb7185",
